...
# Dimesnioni stesse del prof -> N && N-1 (dynamics and input)

# Flag to active the data writing and the plot 
DATA = 1
PLOT = 1
...
if __name__ == "__main__":
    ...
    # Pool logic (since one funciton and different data)
    ...
    # Save the data into a cvs file
        columns = ['q', 'v', 'viable']
        with open('data_single_test.csv', 'w') as f:
            # intestazione
